...
def main():
    ...
    # --------------------------------
    # Aggregated Evaluation Step
    # --------------------------------
    if chosen_csv_paths:
        print("\nRunning aggregated evaluation over processed CSVs...")
        evaluate_models(chosen_csv_paths)
        print("Aggregated evaluation complete.")
    else:
        print("No CSVs were processed for evaluation.")